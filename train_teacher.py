...
def main():
    parser = argparse.ArgumentParser(description="Gomoku Teacher Neural Network Training Pipeline")
    ...
    parser.add_argument("--checkpoint_prefix", type=str, default="teacher_model", help="Prefix for checkpoint filenames")
    ...
    print("=== Gomoku Teacher Neural Network Training Setup ===")
